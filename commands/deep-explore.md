---
name: deep-explore
description: 用 deep-word-explorer 深度解析一个或多个词；支持三轴档位、文风、格式与预设文件参数。
---

# /deep-explore

对 1–8 个词运行 deep-word-explorer 流水线（Step 0–7，含对比师与交付前功能校验）。
...
/deep-explore <词...> [--speed fast|standard|deep] [--depth intro|mid|pro]
  ...
  [--style plain|empathy|narrative|succinct|lucid|direct|natural]
...
3. **执行**：按 SKILL.md 的 Step 0–7 运行（含 Step 7 交付前功能校验）；多词默认生成对比页；
...
/deep-explore 存在主义 --speed deep --depth pro --scope panorama --style narrative
```
